...
class Web3 {
  ...
  /** ******** RAW TRANSACTIONS ********* */
  /**
   * Get the hex address of a Astra address.
   * @param {string} address Astra address
  ...
  /**
   * Converts a hex address to astra address.
   * @param {string} hexAddress Astra address in hex format.
   * @return {Promise} Astra address or Error.
   */
  ...
  /** ******** UTIL ********* */
  /**
   * Validates if a valid Astra address.
   * @param {string} address Astra address to validate.
   ...
   * @param {string} address The astra address for the private key.
  ...
  /**
   * Encrypts the wallet for the first time. This will shut down the astra server.
  ...
  /**
   * Gets the account name associated with the Astra address.
   * @param {string} address The astra address for account lookup.
  ...
  /**
   * Gets the Astra address based on the account name.
  ...
  /**
   * Gets the Astra address with the account name.
   * @param {string} acctName The account name ("" for default).
   * @return {Promise} Astra address array or Error.
   */
  ...
  /**
   * Gets a new Astra address for receiving payments.
   ...
   * @return {Promise} Array of addresses with ASTRA balances or Error.
   */
  ...
  /**
   * Lists unspent transaction outputs.
   * @param {string} address Address to send ASTRA to.
   * @param {number} amount Amount of ASTRA to send.
   ...
   * @param {string} senderAddress The ASTRA address that will be used to send money from.
   ...
   * @param {bumber} amount The transaction fee in ASTRA/kB.
